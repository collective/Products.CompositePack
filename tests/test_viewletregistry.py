...
##############################################################################
"""
$Id: test_viewletregistry.py,v 1.5.2.2 2004/12/21 11:14:03 godchap Exp $
"""
...
class ViewletRegistryTest(ArchetypesTestCase.ArcheSiteTestCase):
    ...
    def testRegisterViewletForType(self):
        ...
        self.failIf(viewlet.isDefaultForType(TEST_TYPE))
        self.failUnless(viewlet in ct.getRegisteredViewletsForType(TEST_TYPE))
    ...
    def testUnregisterViewletForType(self):
        ...
        viewlet = ct.registerViewlet('test_viewlet', 'Test', 'test_viewlet')
        viewlet.registerForType(TEST_TYPE)
        viewlet.unregisterForType(TEST_TYPE)
    ...
    def testDefaultViewletNotRegistered(self):
        ...
        #ct.registerViewletForDefaultSetup(viewlet)
        #ct.setDefaultViewletForDefaultSetup(viewlet)
