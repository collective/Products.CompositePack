...
$Id: archetype.py,v 1.11.2.1 2004/12/21 11:00:17 godchap Exp $
"""
...
class PortalElement(Element):
    """Archetypes-based Composite Element for Portal
    """
    __implements__ = BaseContentMixin.__implements__ + (ICompositeElement,)
    meta_type = portal_type = archetype_name = 'CompositePack Portal Element'
    global_allow = 0
...
registerType(PortalElement, PROJECTNAME)
